    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            if($row["status"] === "Approved") {
                ...
                echo "<td class='td actions eye tooltip'><a href='view leave docs approved.php?application_id=" . $row["application_id"] . "' target='_blank'><i class='fa fa-eye'></i><span class='tooltiptext-eye'>View Leave Document</span></a></td>";
                echo "</tr>";
            }
        }
    } else {
