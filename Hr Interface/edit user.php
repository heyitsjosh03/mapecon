    ...
    <form action="<?php echo($_SERVER["PHP_SELF"]); ?>" method="post">
      ...
      <div class="department-edit">
        <select name="department" id="department-edit" required>
          ...
          <option value="Admin" <?php echo (isset($utype) && $utype == 'Admin') ? 'selected' : ($row['user_status'] == 'Admin' ? 'selected' : ''); ?>>Admin</option>
          <option value="Approver" <?php echo (isset($utype) && $utype == 'Approver') ? 'selected' : ($row['user_status'] == 'Approver' ? 'selected' : ''); ?>>Approver</option>
          <option value="User" <?php echo (isset($utype) && $utype == 'User') ? 'selected' : ($row['user_status'] == 'User' ? 'selected' : ''); ?>>User</option>
        </select>
