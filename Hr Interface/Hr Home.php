...
<div class="content" id="content">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="Hr Decline.php"><i class="fa fa-file-excel-o"></i> Declined Leaves</a>
  </div>
      ...
      <div class="dashboard-content">
        ...
        <div class="card-container-admin">
          <div class="card-container-wrapper">
            <div class="card" onclick="location.href='/mapecon/Hr Interface/Hr Pending.php';" style="cursor: pointer;">
          ...
          <div class="card-container-wrapper">
            <div class="card" onclick="location.href='/mapecon/Hr Interface/Hr Approve.php';" style="cursor: pointer;">
              <div class="card-content">
          ...
          <div class="card-container-wrapper">
            <div class="card" onclick="location.href='/mapecon/Hr Interface/Hr Decline.php';" style="cursor: pointer;">
              <div class="card-content">
