...
<div class="menu"><span class="openbtn" onclick="toggleNav()">&#9776;</span> SUPERVISOR <div id="date-time"></div></div>
...
<div class="container_report_report">
  ...
  <div class="sidebar" id="sidebar">
    <a href="Supervisor Home.php" class="home-sidebar"><i class="fa fa-home"></i> Home</a>
