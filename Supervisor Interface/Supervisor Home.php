...
<header>
  <div class="logo_header">
    <a href="../Supervisor Interface/Supervisor Home.php"> 
  ...
  <div class="profile-dropdown">
    ...
    <label for="profile-dropdown-toggle" class="profile-dropdown">
      ...
      <div class="dropdown-content">
        <a href="Supervisor Profile.php">Profile </a>
        <a href="Supervisor Change Password.php">Change Password</a>
...
<div class="menu">
  <span class="openbtn" onclick="toggleNav()">&#9776;</span> SUPERVISOR <div id="name-greeting">Welcome <span class='user-name'><?php echo $firstName; ?></span>!</div>
</div>
...
<div class="content" id="content">
  ...
  <div class="sidebar" id="sidebar">
    <a href="Supervisor Home.php" class="home-sidebar" id="active"><i class="fa fa-home"></i> Home</a>
      ...
      <div class="dashboard-content">
        ...
        <div class="card-container-admin">
          <div class="card-container-wrapper">
            <div class="card" onclick="location.href='/mapecon/Supervisor Interface/Pending Leaves.php';" style="cursor: pointer;">
          ...
          <div class="card-container-wrapper">
            <div class="card" onclick="location.href='/mapecon/Supervisor Interface/Approved Leaves.php';" style="cursor: pointer;">
              <div class="card-content">
          ...
          <div class="card-container-wrapper">
            <div class="card" onclick="location.href='/mapecon/Supervisor Interface/Declined Leaves.php';" style="cursor: pointer;">
              <div class="card-content">
