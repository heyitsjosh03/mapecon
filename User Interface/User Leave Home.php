...
<header>
  ...
  <div class="menu"><span class="openbtn" onclick="toggleNav()">&#9776;</span> Leave Management System <div id="name-greeting">Welcome <span class='user-name'><?php echo $firstName; ?></span>!</div></div>
